 ...
 */
@Service
public class MainDefaultUserContextService {

    private final MainDefaultUserContextCache mainDefaultUserContextCache;
    private final UserDataService userDataService;

    public MainDefaultUserContextService(MainDefaultUserContextCache mainDefaultUserContextCache, UserDataService userDataService) {
    ...
    public String getCurrentUsername() {
        return mainDefaultUserContextCache.getCurrentUsername();
    }
    ...
    public boolean isCacheHealthy() {
        return mainDefaultUserContextCache.isHealthy();
    }
    ...
    public boolean forceRefresh() {
        return mainDefaultUserContextCache.forceRefresh();
    }
    ...
    public void performMidnightReset() {
        try {
            ...
            if (mainDefaultUserContextCache.isElevated()) {
            ...
            mainDefaultUserContextCache.midnightReset();
            LoggerUtil.info(this.getClass(), "MainDefaultUserContextService midnight reset completed");
    ...
    public void initializeFromUser(User user) {
        try {
            if (user != null) {
                mainDefaultUserContextCache.updateFromLogin(user);
    ...
    public void handleLogout() {
        boolean wasElevated = mainDefaultUserContextCache.isElevated();
        ...
        if (wasElevated) {
            ...
            // mainDefaultUserContextCache.invalidateCache();
    ...
    public void elevateToAdminRole(User adminUser) {
        ...
        try {
            mainDefaultUserContextCache.elevateToAdminRole(adminUser);
            LoggerUtil.info(this.getClass(), String.format(
    ...
    public boolean isElevated() {
        return mainDefaultUserContextCache.isElevated();
    }
    ...
    private void handleAdminElevation(User adminUser) {
        try {
            ...
            if (!mainDefaultUserContextCache.isHealthy()) {
