...
/**
 * ENHANCED MainDefaultUserContextCache with Role Elevation Support.
 ...
 */
@Component
public class MainDefaultUserContextCache {
    ...
    @Autowired
    public MainDefaultUserContextCache(UserDataService userDataService) {
    ...
    public void initialize() {
        LoggerUtil.info(this.getClass(), "Initializing MainDefaultUserContextCache with role elevation support");
        refreshCacheFromFile("initialization");
        LoggerUtil.info(this.getClass(), "MainDefaultUserContextCache initialized successfully");
    }
    ...
    public void shutdown() {
        LoggerUtil.info(this.getClass(), "MainDefaultUserContextCache shutting down");
