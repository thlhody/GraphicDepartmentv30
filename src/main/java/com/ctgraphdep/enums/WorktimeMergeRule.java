...
public enum WorktimeMergeRule {
    ...
    USER_INPUT_PRIORITY((user, admin) ->
            user != null && SyncStatusMerge.USER_INPUT.equals(user.getAdminSync()) &&
    ...
    USER_IN_PROCESS((user, admin) ->
            user != null && SyncStatusMerge.USER_IN_PROCESS.equals(user.getAdminSync()),
            (user, admin) -> user),
    ...
    ADMIN_EDITED((user, admin) ->
            admin != null && SyncStatusMerge.ADMIN_EDITED.equals(admin.getAdminSync()) && (user == null || (!SyncStatusMerge.USER_IN_PROCESS.equals(user.getAdminSync()) &&
    ...
    USER_EDITED_PROTECTION((user, admin) ->
            user != null &&
                    SyncStatusMerge.USER_EDITED.equals(user.getAdminSync()) &&
                    admin != null &&
                    SyncStatusMerge.ADMIN_BLANK.equals(admin.getAdminSync()),
            (user, admin) -> user),
    ...
    ADMIN_BLANK((user, admin) ->
            admin != null &&
                    SyncStatusMerge.ADMIN_BLANK.equals(admin.getAdminSync()) &&
                    (user == null || !SyncStatusMerge.USER_EDITED.equals(user.getAdminSync())),
            (user, admin) -> null),
    ...
    public static WorkTimeTable apply(WorkTimeTable user, WorkTimeTable admin) {
        ...
        if (user != null && SyncStatusMerge.USER_IN_PROCESS.equals(user.getAdminSync())) {
        ...
        if (admin != null && SyncStatusMerge.ADMIN_BLANK.equals(admin.getAdminSync()) && (user == null || !SyncStatusMerge.USER_EDITED.equals(user.getAdminSync()))) {
