 ...
 * StatusDisplay.js
 *
 * Handles status indicators and editability checking for time management.
 * Manages status tooltips, modals, and row-level status information.
 *
 * @module features/time-management/StatusDisplay
 */
...
/**
 * StatusDisplay class
 * Manages status display and editability
 */
export class StatusDisplay {
     ...
     */
    static initializeStatusTooltips() {
     ...
     */
    static setupStatusModalHandlers() {
     ...
     * @private
     */
    static _extractStatusFromDOM(row) {
     ...
     */
    static checkStatusBasedEditability(cell) {
     ...
     */
    static showStatusDetails(statusElement, event) {
     ...
     * @private
     */
    static _buildStatusDetailsContent(statusInfo, date) {
        let content = `
     ...
     * @private
     */
    static _showModalWithFocusHandling(modal, originalElement) {
        modal.show();
     ...
     */
    static refreshCellEditability(cell) {
        // Reset classes
        cell.classList.remove('status-locked');
     ...
     */
    static refreshRowEditability(row) {
    ...
    static getRowData(row) {
        ...
        // Get overtime information using TimeManagementUtilities
