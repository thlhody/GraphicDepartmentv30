...
export class DashboardAutoRefresh {
    ...
    showRefreshIndicator() {
        ...
        this.currentToastId = window.ToastNotification.info(
            'Updating',
            'Loading fresh user data in background...',
            {
                persistent: true,
    ...
    showSuccessMessage() {
        ...
        window.ToastNotification.success(
            'Updated',
            'Dashboard metrics refreshed with latest data'
        );
    }
    ...
    showTimeoutMessage() {
        ...
        window.ToastNotification.warning(
            'Timeout',
            'Refresh is taking longer than expected. The dashboard will continue updating in the background.',
            { duration: 8000 }
        );
    }
    ...
    showErrorMessage() {
        ...
        window.ToastNotification.error(
            'Error',
            'Unable to check refresh status. Please try refreshing the page.',
            { duration: 8000 }
        );
    }
